...
//#region node_modules/react-paystack/dist/index.es.js
...
function usePaystackScript() {
	...
	(0, import_react.useEffect)(function() {
		if (cachedScripts.includes(src)) setState({
			loaded: true,
			error: false
		});
		else {
...
function usePaystackPayment(hookConfig) {
	...
	function initializePayment(_a) {
		...
		if (scriptError) throw new Error("Unable to load paystack inline script");
		...
		if (scriptLoaded) callPaystackPop({
...
var PaystackProvider = function(_a) {
	...
	var initializePayment = usePaystackPayment(config);
	return import_react.createElement(PaystackContext.Provider, { value: {
		config,
		initializePayment,
		onSuccess,
		onClose
...
var PaystackConsumer = (0, import_react.forwardRef)(function(_a, ref) {
	...
	return import_react.createElement(PaystackProvider, __assign({}, others, {
		onSuccess,
		onClose
	}), import_react.createElement(PaystackConsumerChild, { ref }, children));
});
//#endregion
